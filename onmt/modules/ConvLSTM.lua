...
--]]
local ConvLSTM, parent = torch.class('onmt.ConvLSTM', 'onmt.Network')
...
--]]
function ConvLSTM:__init(layers, inputSize, hiddenSize, dropout, residual, dropout_input, dropout_type, numFilt)
...
function ConvLSTM:_buildModel(layers, inputSize, hiddenSize, dropout, residual, dropout_input, dropout_type, numFilt)
  local inputs = {}
  local outputs = {}
...
function ConvLSTM:_buildLayer(inputSize, hiddenSize, numFilt)
  local inputs = {}
  ...
  _G.logger:info('In ConvLSTM layer prep')
